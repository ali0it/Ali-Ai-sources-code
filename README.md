...
انتقل إلى مجلد المشروع باستخدام الأمر cd.
...
Run the following command to bypass execution policies temporarily: Set-ExecutionPolicy Bypass -Scope Process -Force
Execute the installation script: .\install.ps1
Once the setup is complete, navigate to your software project's directory and run the AI tool to utilize all advanced features.
🛡️ Cybersecurity
